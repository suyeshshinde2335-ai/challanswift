...
# ----------------- MAIN PROGRAM v3.0 -----------------
type_effect("\n=== Welcome to CHALLANSWIFT v3.0: Emergency Override System ===", 0.05)
type_effect("------------------------------------------------------------", 0.05)
...
# Naya Feature: Emergency Vehicle Check
...
if emergency_check.lower() == "yes":
    print("\n🚨 EMERGENCY VEHICLE DETECTED! All traffic penalties waived automatically. 🚨")
    violations_list = "* EMERGENCY VEHICLE OVERRIDE (Fine: Rs 0)\n"
else:
    # Select Vehicle Type (Normal Checking)
    print("\nSelect Vehicle Type:")
...
print("\n==============================================")
type_effect("       CHALLANSWIFT DIGITAL RECEIPT v3.0  ", 0.04)
print("==============================================")
...
print("==============================================")
type_effect("Drive safe and support emergency vehicles! 🚑⚡", 0.04)